...
FUSION_PROMPT_SETTLE_SEC="${FUSION_PROMPT_SETTLE_SEC:-1.0}"
FUSION_CONTAINER_CENTER_KEYPOINT="${FUSION_CONTAINER_CENTER_KEYPOINT:-true}"
FUSION_CONTAINER_CENTER_INNER_FRACTION="${FUSION_CONTAINER_CENTER_INNER_FRACTION:-0.55}"
FUSION_CONTAINER_CENTER_Z_PERCENTILE="${FUSION_CONTAINER_CENTER_Z_PERCENTILE:-20.0}"
FUSION_CONTAINER_CENTER_Z_OFFSET_M="${FUSION_CONTAINER_CENTER_Z_OFFSET_M:-0.0}"
FUSION_CONTAINER_CENTER_MIN_POINTS="${FUSION_CONTAINER_CENTER_MIN_POINTS:-48}"
...
PREFER_VISUAL_TRAY_CENTER_KEYPOINT="${PREFER_VISUAL_TRAY_CENTER_KEYPOINT:-true}"
VISUAL_TRAY_CENTER_MAX_DISTANCE_M="${VISUAL_TRAY_CENTER_MAX_DISTANCE_M:-0.19}"
STATIC_TRAY_CENTER_FALLBACK_SEC="${STATIC_TRAY_CENTER_FALLBACK_SEC:-3.0}"
FORCE_STATIC_TRAY_RELEASE_FOR_MEDICAL_OBJECTS="${FORCE_STATIC_TRAY_RELEASE_FOR_MEDICAL_OBJECTS:-true}"
...
FUSION_CONTAINER_CENTER_EXPECTED_WORLD="${FUSION_CONTAINER_CENTER_EXPECTED_WORLD:-$STATIC_TRAY_CENTER_WORLD}"
FUSION_CONTAINER_CENTER_EXPECTED_MAX_DISTANCE_M="${FUSION_CONTAINER_CENTER_EXPECTED_MAX_DISTANCE_M:-0.19}"
  ...
  start)
    ...
    start_bg_ros fusion \
      "ros2 run perception_geometry mask_depth_fusion_node --ros-args \
       ...
       -p prompt_settle_sec:=$FUSION_PROMPT_SETTLE_SEC \
       -p enable_container_center_keypoint:=$FUSION_CONTAINER_CENTER_KEYPOINT \
       -p container_center_inner_fraction:=$FUSION_CONTAINER_CENTER_INNER_FRACTION \
       -p container_center_z_percentile:=$FUSION_CONTAINER_CENTER_Z_PERCENTILE \
       -p container_center_z_offset_m:=$FUSION_CONTAINER_CENTER_Z_OFFSET_M \
       -p container_center_min_points:=$FUSION_CONTAINER_CENTER_MIN_POINTS \
       -p container_center_expected_world:=$FUSION_CONTAINER_CENTER_EXPECTED_WORLD \
       -p container_center_expected_max_distance_m:=$FUSION_CONTAINER_CENTER_EXPECTED_MAX_DISTANCE_M \
    ...
    if is_truthy "$KEYPOINT_DEBUG_ONLY"; then
      ...
      start_bg_ros executor \
        "ros2 run pybullet_ros2_sim llm_task_executor_node --ros-args \
         ...
         -p prefer_visual_tray_center_keypoint:=$PREFER_VISUAL_TRAY_CENTER_KEYPOINT \
         -p visual_tray_center_max_distance_m:=$VISUAL_TRAY_CENTER_MAX_DISTANCE_M \
         -p static_tray_center_fallback_sec:=$STATIC_TRAY_CENTER_FALLBACK_SEC \
         -p force_static_tray_release_for_medical_objects:=$FORCE_STATIC_TRAY_RELEASE_FOR_MEDICAL_OBJECTS \
    ...
    info "static_tray_center_target=$USE_STATIC_TRAY_CENTER_TARGET prefer_visual_tray_center=$PREFER_VISUAL_TRAY_CENTER_KEYPOINT visual_max_dist=$VISUAL_TRAY_CENTER_MAX_DISTANCE_M fallback_sec=$STATIC_TRAY_CENTER_FALLBACK_SEC force_static_medical_release=$FORCE_STATIC_TRAY_RELEASE_FOR_MEDICAL_OBJECTS center_world=$STATIC_TRAY_CENTER_WORLD plane_normal_world=$STATIC_TRAY_PLANE_NORMAL_WORLD"
    info "sam3 score_th=$SAM3_SCORE_TH mask_th=$SAM3_MASK_TH fusion_min_score=$FUSION_MIN_SCORE"
    info "fusion_container_center_keypoint=$FUSION_CONTAINER_CENTER_KEYPOINT prompt_settle=$FUSION_PROMPT_SETTLE_SEC inner_fraction=$FUSION_CONTAINER_CENTER_INNER_FRACTION z_percentile=$FUSION_CONTAINER_CENTER_Z_PERCENTILE z_offset=$FUSION_CONTAINER_CENTER_Z_OFFSET_M expected_world=$FUSION_CONTAINER_CENTER_EXPECTED_WORLD expected_max_dist=$FUSION_CONTAINER_CENTER_EXPECTED_MAX_DISTANCE_M"
